...
const data = INDUSTRY_PAGES["chemical-processing-equipment"];
          ...
          {applicableProducts.map((product, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: 0.1 * index }}
                className="group rounded-xl border border-white/[0.10] bg-[#12121a]/80 p-6 border-t-2 border-t-accent/30 hover:bg-[#1a1a28]/80 hover:border-white/[0.15] transition-all duration-300 flex flex-col"
              >
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.h2
          ...
          className="text-2xl md:text-4xl font-heading font-bold text-white tracking-tight"
        >
          Ready to bring intelligence to your{" "}
          {data.name.toLowerCase()} workflow?
        </motion.h2>
        ...
        >
          See how Cognaize can work for your specific processes. Book a
...
export default function ChemicalProcessingEquipmentPage() {
  return (
    <div>
      <HeroSection />
      <ChallengeSection />
