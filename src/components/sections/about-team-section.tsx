                ...
                <div className="flex-shrink-0 relative self-start">
                  ...
                  {member.linkedin && (
                    <a
                      ...
                      className="absolute -bottom-1.5 -right-1.5 inline-flex items-center justify-center w-7 h-7 rounded-md bg-[#0A66C2] hover:bg-[#0a5db1] text-white ring-2 ring-[#1a1028] shadow-md transition-colors"
                    >
              ...
              <div className="relative w-20 h-20 mx-auto mb-3">
                ...
                {member.linkedin && (
                  <a
                    ...
                    rel="noopener noreferrer"
                    aria-label={`${member.name} on LinkedIn`}
                    className="absolute bottom-0 right-0 inline-flex items-center justify-center w-6 h-6 rounded-md bg-[#0A66C2] hover:bg-[#0a5db1] text-white ring-2 ring-[#12121a] shadow-md transition-colors"
                  >
